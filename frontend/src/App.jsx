...
function App() {
      ...
      <section className="hero-section" id="home">
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p>
              Track vehicles, drivers, trips, fuel, maintenance,
              expenses and live fleet activity from one centralized
              fleet management platform.
            </p>
          ...
          <div className="why-visual">
            ...
            <div className="small-info-card">
              ...
              <div>
                ...
                <span>43 of 48 vehicles operational</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="contact-container">
    <div className="contact-content">
      ...
      <p>
        Have questions about FleetFlow? Our team is here to help you manage
      ...
      <section className="cta-section">
        <div className="cta-container">
          <div>
            ...
            <p>
             Monitor every vehicle and optimize your fleet operations
            </p>
          </div>
